...
string json = PrintOrder(Product.CreateNew(10), "Json");
string plain = PrintOrder(Product.CreateNew(10), "PlainText");
...
static string PrintOrder(Product order, string formatType)
{
